...
Approved scope: version the existing project in `public` GitHub repository `ottrp0p/marketing_measurement`, using an initial import branch and human PR review.
...
Retain the delivered compendium PDF/image, LaTeX and Markdown sources, Python experiments and compact JSON/NPY research results. Exclude caches, execution logs and LaTeX build intermediates.
